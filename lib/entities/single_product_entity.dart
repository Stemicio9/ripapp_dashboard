...
class SingleProductEntity {
  final int
      id; //fixme vedere se questo id va bene, l'ho aggiunto ma non so se logicamente va messo
  final String name;
  final String price;
  ...
  static void constantFunction(SingleProductEntity singleProductEntity,
      SearchProductsOfferedLoaded state) {}
  ...
  SingleProductEntity copyWith(
      ...
      String? price,
      bool? isSelected,
      Function(SingleProductEntity, SearchProductsOfferedLoaded)? onTap}) {
